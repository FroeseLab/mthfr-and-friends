...
```{r Save the plot}
# Open a PNG device
png(filename = "../data/output/upset_plot_SAINT_input.png",   height = 8,
    width = 13,
    units = "in", res=300)
upset_plot_SAINT_input
# Close the device
...
#Re-name 
data_raw_SAINT_output <- data_raw_SAINT_output %>%
  mutate(`Bait` = case_when(
    `Bait` == "MTHFR_38to656" ~ "MTHFR_38-656",
     `Bait` == "MTHFR" ~ "MTHFR_WT",
    TRUE ~ `Bait`
  ))
...
# Open a PNG device
png(filename = "../data/output/upset_SAINT_output.png", height = 8,
    width = 13,
    units = "in", res=300)
upset_plot_SAINT_output
# Close the device
...
```{r}
# Open a PNG device
png(filename = "../data/output/upset_SAINT_output_SP_0.95_FCA_2.png", height = 8,
    width = 13,
    units = "in", res=300)
upset_plot_SAINT_output
# Close the device
